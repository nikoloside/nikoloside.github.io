            ...
            <div className="about-cards">
              <div className="about-card story-card">
                ...
                <div className="card-content">
                  ...
                  <p>
                    Motivated by personal experiences in senior care, he aims to develop AI and robotics systems that interpret spatial environments while preserving privacy. He is currently leading the SpaceRAG project etc. , which integrates robotics and Position-Based Dynamics (PBD) for embodied AI systems.
                  </p>
                </div>
              </div>
